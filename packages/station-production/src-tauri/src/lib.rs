//! Production Station - Tauri Commands
//!
//! Native commands for file operations, hotfolder management, and printer status
...
pub fn run() {
    tauri::Builder::default()
        ...
        .expect("error while running Production Station");
}
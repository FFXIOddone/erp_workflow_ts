...
function App() {
  ...
  const [activeTab, setActiveTab] = useState<'design' | 'files' | 'communication'>('design');
    ...
    <div className="h-screen flex flex-col bg-gray-100 no-select">
      ...
      <header className="bg-white border-b border-gray-200 px-4 py-2 flex items-center justify-between shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-bold text-gray-900">Design Station</h1>
            <p className="text-xs text-gray-500">Graphics & Layout</p>
          </div>
        </div>
      ...
      <main className="flex-1 overflow-hidden">
        {activeTab === 'design' && <DesignQueuePanel />}
        
        {activeTab === 'files' && (
          <div className="h-full p-4">
            <FileExplorer onSendToHotfolder={() => {}} />
          </div>
        )}
        ...
        {activeTab === 'communication' && (
          <div className="h-full flex items-center justify-center text-gray-500">
            <div className="text-center">
              ...
              <p className="text-lg font-medium">Customer Communication</p>
              <p className="text-sm">Coming soon - view proof responses and customer emails</p>
            </div>
          </div>
        )}
      </main>

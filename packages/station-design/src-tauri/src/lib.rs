//! Design Station - Tauri Commands
//!
//! Native commands for file operations, design software integration, and asset management
...
pub fn run() {
    tauri::Builder::default()
        ...
        .expect("error while running Design Station");
}
//! Shipping Station - Tauri Commands
//!
//! Native commands for file operations, shipping label generation, and package tracking
...
pub fn run() {
    tauri::Builder::default()
        ...
        .expect("error while running Shipping Station");
}